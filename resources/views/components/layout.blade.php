<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full bg-blue-200">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img src="https://www.explodingkittens.com/cdn/shop/files/ek-kitten_x500_2x_38cc30f3-b6db-45b6-bd2f-0623fdfd39d8_1207x.webp?v=1668130988"
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/NoContactPage"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">No
                                    contact page</a>
                                <a href="/catpage"
                                    class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">cat
                                    page</a>
                                <a href="#"
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                <button
                                    ...
                                    <img src="https://variety.com/wp-content/uploads/2022/05/Exploding-Kittens-the-Game-Netflix.png"
