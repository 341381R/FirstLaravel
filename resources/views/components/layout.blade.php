            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="flex h-16 items-center justify-between">
                    <div class="flex items-center">
                        <div class="shrink-0">
                            <img src="https://www.explodingkittens.com/cdn/shop/files/ek-kitten_x500_2x_38cc30f3-b6db-45b6-bd2f-0623fdfd39d8_1207x.webp?v=1668130988" alt="Your Company" class="size-8" />
                        </div>
                        ...
                        <div class="ml-4 flex items-center md:ml-6">
                            ...
                            <el-dropdown class="relative ml-3">
                                <button class="relative flex max-w-xs items-center rounded-full focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500">
                                    ...
                                    <img src="https://variety.com/wp-content/uploads/2022/05/Exploding-Kittens-the-Game-Netflix.png" alt="" class="size-8 rounded-full outline -outline-offset-1 outline-white/10" />
                                </button>
                            </el-dropdown>
                        </div>
                    </div>
